...
class _AddTransactionScreenState extends State<AddTransactionScreen> {
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  _buildToggleButton('Income', false, colors),
                  _buildToggleButton('Expense', true, colors),
                ],
              ),
            ),
            ...
            _buildLabel('Reference / Label', colors),
            ...
            if (!_isExpense) ...[
              _buildLabel('Income Type', colors),
              const SizedBox(height: 12),
              _buildIncomeCategoryList(colors),
            ] else ...[
              _buildLabel('What was this expense for?', colors),
              const SizedBox(height: 8),
              _buildTextField(
            ...
            _buildLabel('Note (optional)', colors),
            const SizedBox(height: 8),
            _buildTextField(
  ...
  Widget _buildToggleButton(
      String label, bool isExpense, AppColors colors) {
  ...
  Widget _buildIncomeCategoryList(AppColors colors) {
    return Column(
